...
echo "Operator is installed, you should be able to start it by passing operator or /opt/operator/operator to your SSH session. IMPORTANT: Make sure to set your exposed IP in Operator's local settings to 0.0.0.0 by clicking on Settings in Operator. You will not be able to interact with the Pneuma agents until you do this."
