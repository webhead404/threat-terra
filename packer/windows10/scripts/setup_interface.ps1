...
# Change MacAddress
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Class\{4D36E972-E325-11CE-BFC1-08002BE10318}\0000" -Name 'NetworkAddress' -Value '0050560A2B1C2' -Type String 

# Set vars
$nic_id=((Get-NetAdapter | where {$_.Name -eq 'Ethernet'}).DeviceID.ToLower())
